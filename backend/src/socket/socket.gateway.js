...
var SocketGateway = function () {
    ...
    var SocketGateway = _classThis = /** @class */ (function () {
        function SocketGateway_1() {
            this.server = __runInitializers(this, _server_initializers, void 0);
            __runInitializers(this, _server_extraInitializers);
        }
        SocketGateway_1.prototype.emitOrdersUpdated = function () {
            this.server.emit('ordersUpdated');
        };
        return SocketGateway_1;
    }());
